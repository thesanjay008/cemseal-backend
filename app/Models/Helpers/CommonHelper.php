	...
	*/
	...
	public static function sendMessage($to, $message = ""){
		...
		try {
			...
			$vars = '{"messages":[{"recipient":"'. $to .'","priority":"2","message-id":"'. rand('9999999', '999999999') .'","sms":{"originator":"amen inch","content":{"text":"'. $message .'"}}}]}';
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL,"http://45.131.124.7/broker-api/send");
			curl_setopt($ch, CURLOPT_POST, 1);
			curl_setopt($ch, CURLOPT_POSTFIELDS,$vars);  //Post Fields
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
			curl_setopt($ch, CURLOPT_USERPWD, "ameninch:ameninch123");
