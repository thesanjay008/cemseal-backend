...
@section('content')
			...
			<div class="page-title-heading">
				<div>
					<div class="page-title-head center-elem">
						...
						<span class="d-inline-block">{{ trans('paymentGateway.heading') }}</span>
					</div>
				</div>
			</div>
				...
				<div class="page-title-subheading opacity-10">
					<nav class="" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"> <a>{{ trans('paymentGateway.plural') }}</a></li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<div class="main-card mb-3 card">
		<div class="card-header-tab card-header">
			<div class="card-header-title font-size-lg text-capitalize font-weight-normal">{{trans('paymentGateway.list')}}</div>
