					...
					<div class="form-row">
						<div class="col-md-4">
							<div class="position-relative form-group">
								...
								<input id="name" type="text" class="form-control" value="{{$data->name}}" placeholder="{{ trans('user.placeholder.name') }}">
					...
					<div class="form-row">
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<input id="mobile_number" type="text" class="form-control" value="{{$data->mobile_number}}" placeholder="{{ trans('user.placeholder.mobile_number') }}">
						...
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<input id="email" type="text" class="form-control" value="{{$data->email}}" placeholder="{{ trans('user.placeholder.email') }}">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<select  class="form-control" id="user_type">
									<option value="Cashier" @if($data->user_type ==  'Cashier') selected @endif>Cashier</option>
								</select>
							</div>
						</div>
						<div class="col-md-2">
