                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="collapse dont-collapse-sm contacts" id="collapse_3">
                        <ul>
                            ...
                            <li><i class="icon_mail_alt"></i><a href="mailto:{{ Settings::get('site_email') }}">{{ Settings::get('site_email') }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="row add_bottom_25">
                ...
                <div class="col-lg-6">
                    <ul class="additional_links">
                        ...
                        <li><span>Maintained by <a href="https://www.codefencers.com" target="_blank">CodeFencers</a></span></li>
                    </ul>
                </div>
            </div>
        </div>
